...
public class SearchGalleryScreenActivity extends AppCompatActivity {
    ...
    private static final String CLOUD_VISION_API_KEY = "AIzaSyCknmQm-gisLekqcEqUmnytXpCja7PKgeY";
    ...
    private static final String TAGAPI = SearchGalleryScreenActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMainImage = findViewById(R.id.gallery_view);
...
/*
    ...
    private void callCloudVision(final Bitmap bitmap) {
        ...
        try {
            AsyncTask<Object, Void, String> labelDetectionTask = new SearchGalleryScreenActivity.LableDetectionTask(this, prepareAnnotationRequest(bitmap));
